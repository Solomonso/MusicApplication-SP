...
class SettingActivity : AppCompatActivity(){
    ...
    private lateinit var signOutSpotifyButton: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        signOutSpotifyButton = findViewById(R.id.sign_out_spotify_button)
    ...
    private fun showUnlinkButton() {
        signOutSpotifyButton.visibility = View.VISIBLE
        signSpotifyButton.visibility = View.GONE
    }
}