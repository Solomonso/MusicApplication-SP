...
class YoutubePlaylistAdapter(private val playlists: ArrayList<Playlist>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView =
            LayoutInflater.from(parent.context).inflate(R.layout.user_playlists, parent, false)
    ...
    inner class MyViewHolder(itemView: View, listener: OnPlaylistClickListener) :
